...
import { AssignmailboxComponent } from '../../assignmailbox/assignmailbox.component';
  ...
  @Component({
    selector: 'app-admin-mailbox-request',
    templateUrl: './admin-mailbox-request.component.html',
    styleUrls: ['./admin-mailbox-request.component.css']
  })
  export class AdminMailboxRequestComponent implements OnInit {
