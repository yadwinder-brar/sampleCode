...
import { ProInvoiceDialogComponent } from './pro-invoice-dialog/pro-invoice-dialog.component';

@Component({
  selector: 'app-invoicesbilling',
  templateUrl: './invoicesbilling.component.html',
  styleUrls: ['./invoicesbilling.component.css']
})
export class InvoicesbillingComponent implements OnInit {
  InvoiceList: any;
