...
import { PostOfficeFormDetailComponent } from 'src/app/features/admin/mailboxrequest/post-office-form-detail/post-office-form-detail.component';

@Component({
  selector: 'app-subadmin-mailbox-request-detail',
  templateUrl: './subadmin-mailbox-request-detail.component.html',
  styleUrls: ['./subadmin-mailbox-request-detail.component.css']
})
export class SubadminMailboxRequestDetailComponent implements OnInit {
  ...
  Assignmailbox(id: any): void {
    const dialogRef = this.dialog.open(AssignmailboxComponent, {
      ...
      if(res){
        ...
        this._router.navigate(['/subAdmin/mailbox-request']);
      }
    })
  }
